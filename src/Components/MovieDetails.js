...
const MovieDetails = () => {
    ...
    // بتجيبلك الباراميتر اللي جوا اللنك االلي رحتله , انا هان رحت لهاد الكمبوننت نفسه واله باراميتر اسمه اي دي فاخدته
    // من الايدي قدرت اجيب الفلم تاعي مع التفاصيل اللي بديي اياها
    //يعني في الاب مررت اي دي عشان اقدر استفيد منه هان
    console.log(param)
